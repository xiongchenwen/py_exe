    ...
    if TOP_EDGE:
        ...
        if O1[0] < O2[0]:
            if O1[1] < O2[1]:
                ...
                arc1_x, arc1_y = arc(turn_r, degree1 + 270, 360 + degree3, O1[0], O1[1])
                arc2_x, arc2_y = arc(turn_r, degree4, 90 + degree1, O2[0], O2[1])
                arc3_x, arc3_y = arc(turn_r, 180 + degree3, 180 + degree4, O3[0], O3[1])
        else:
            pass
        ...
        if degree3 < 0:
            ...
            # arc1_x.reverse()
            # arc1_y.reverse() # reverse()将数据倒置
        else:
            arc1_x, arc1_y = arc(turn_r, degree3 + 180, 270 + degree1, O1[0], O1[1])
            arc2_x, arc2_y = arc(turn_r, degree1 + 90, 180 + degree4, O2[0], O2[1])
            arc3_x, arc3_y = arc(turn_r, degree4, degree3, O3[0], O3[1])
    ...
    for x in range(0, targ - 1):
        ...
        if x % 2 == 0:
            ...
            if all_turn_name[x] == "T":
                ...
                turn = O_turn(a, b, turn_r, TOP_EDGE, min_angle)
