...
def U_turn(A, B, turn_r, TOP_EDGE, min_angle):
    ...
    if TOP_EDGE:
        ...
        # O2 = [B[0] - turn_r, B[1]]
        degree2 = math.degrees(math.atan((O1[1] - O2[1]) / (O1[0] - O2[0])))
        radian_2 = math.radians(degree2)
        print('degree2', degree2)
        if O1[1] < O2[1]:
            degree_2 = 360 - (90 - degree2)
            radian2 = math.radians(degree_2)
            # print('degree2', degree2)
            ...
            H1 = [O1[0] - turn_r * math.sin(radian_2), O1[1] + turn_r * math.cos(radian_2)]
            H2 = [O2[0] - turn_r * math.sin(radian_2), O2[1] + turn_r * math.cos(radian_2)]
            print('H1', H1)
            print('H2', H2)
