...
def U_turn(A, B, turn_r, TOP_EDGE, min_angle):
    ...
    if TOP_EDGE:
        ...
        # print('H1', H1)
        arc1 = arc(turn_r, degree2, 180+degree3, O1[0], O1[1])
        arc1[0].reverse()
        arc1[1].reverse()
        arc2 = arc(turn_r, degree3, degree2, O2[0], O2[1])
        arc2[0].reverse()
        arc2[1].reverse()
        line_x = [H1[0], H2[0]]
        line_y = [H1[1], H2[1]]
        ...
        # print('H1', H1)
        H2 = [O2[0] + turn_r * math.cos(radian2), O2[1] + turn_r * math.sin(radian2)]
        arc1 = arc(turn_r, 180+degree3, degree2, O1[0], O1[1])
        arc2 = arc(turn_r, degree2, 360+degree3, O2[0], O2[1])
        line_x = [H1[0], H2[0]]
        line_y = [H1[1], H2[1]]
        x = arc1[0] + line_x + arc2[0]
        y = arc1[1] + line_y + arc2[1]
