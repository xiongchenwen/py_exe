...
class Application(QMainWindow, Ui_MainWindow):
    ...
    def Drawing(self):
        ...
        top_list, low_list, point = algorithm.Rec_turn_point(self, point_1, point_offset, path_width, min_angle)
        ...
        #
        # top_point, low_point = algorithm.Rec_turn_point(self, point_1, point_offset, path_width)
        ...
        algorithm.polyScan_Draw(self, point_1, point_offset, path_width, min_angle)
